...
namespace fluffyUnicorns.Models
{
	...
	public partial class link : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _lnk_title;
		
		private string _lnk_url;
    ...
    partial void OnidChanging(int value);
    partial void OnidChanged();
    partial void Onlnk_titleChanging(string value);
    partial void Onlnk_titleChanged();
    partial void Onlnk_urlChanging(string value);
    partial void Onlnk_urlChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_lnk_title", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string lnk_title
		{
			get
			{
				return this._lnk_title;
			}
			set
			{
				if ((this._lnk_title != value))
				{
					this.Onlnk_titleChanging(value);
					this.SendPropertyChanging();
					this._lnk_title = value;
					this.SendPropertyChanged("lnk_title");
					this.Onlnk_titleChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_lnk_url", DbType="VarChar(150) NOT NULL", CanBeNull=false)]
		public string lnk_url
		{
			get
			{
				return this._lnk_url;
			}
			set
			{
				if ((this._lnk_url != value))
				{
					this.Onlnk_urlChanging(value);
					this.SendPropertyChanging();
					this._lnk_url = value;
					this.SendPropertyChanged("lnk_url");
					this.Onlnk_urlChanged();
				}
			}
		}
