...
namespace fluffyUnicorns.Models
{
    ...
    partial void Deletebookmark(bookmark instance);
		...
		public int addContact([global::System.Data.Linq.Mapping.ParameterAttribute(DbType="VarChar(50)")] string parName, [global::System.Data.Linq.Mapping.ParameterAttribute(DbType="VarChar(50)")] string parEmail, [global::System.Data.Linq.Mapping.ParameterAttribute(DbType="VarChar(MAX)")] string parMsg)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), parName, parEmail, parMsg);
